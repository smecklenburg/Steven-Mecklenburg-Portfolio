    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.logButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "Data read: " + mExercise + " " + mWeight + " " + mReps);
                insertGymLogRecord();
            }
        });
    }
    ...
    private void loginUser(Bundle savedInstanceState) {
        ...
        userObserver.observe(this, user -> {
            ...
            if (user != null) {
                ...
                Log.d(TAG, "User loaded: " + user.getUsername() + " (id=" + user.getId() + ")");

                gymLogViewModel.getAllLogsById(user.getId())
                        .observe(this, gymLogs -> {
                            Log.d(TAG, "Observer triggered: " + gymLogs.size() + " logs");
                            adapter.submitList(gymLogs);
                        });
            }
        });
